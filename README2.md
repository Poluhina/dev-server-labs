...
На этом этапе, создала RESTful API, которое предоставляет набор CRUD операций. Этот набор для двух сущностей: Categorie и Todos.
# API для категорий
API для Categorie позваляет выполнять операции, чтения, создания, редактирования и удаления категорий.
# Таблица оперции
```
...
-Легче писать код, меньше ошибок в SQL.
-Поддержка миграций и связей между таблицами.
